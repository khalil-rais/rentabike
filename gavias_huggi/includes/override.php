<?php
function gavias_huggi_preprocess_views_view_unformatted__taxonomy_term(&$variables){
...
function gavias_huggi_preprocess_views_view_unformatted(&$variables) {
   $view = $variables['view'];
   $rows = $variables['rows'];
...
function gavias_huggi_preprocess_views_view_grid(&$variables) {
   $view = $variables['view'];
   $rows = $variables['rows'];
   $style = $view->style_plugin;
   $options = $style->options;
