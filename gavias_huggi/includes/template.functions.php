<?php
function gavias_huggi_base_url(){
  global $base_url;
  $theme_path = drupal_get_path('theme', 'gavias_huggi');
  return $base_url . '/' . $theme_path . '/';
}

function gavias_huggi_preprocess_node(&$variables) {
...
function gavias_huggi_preprocess_field(&$variables, $hook) {
  $element = $variables['element'];
}  

function gavias_huggi_preprocess_breadcrumb(&$variables){
